...
const QUESTIONS = [
  { dim:"WS", aVal:"W", dimLabel:"📝 论文风格", title:"📝 字数还差800字，截止还有2小时，你怎么办？",
    a:{ label:"注水派", desc:"把每个句子扩写，加点「在此基础上」「综上所述」，把背景再介绍一遍" },
    b:{ label:"实干派", desc:"看哪个论点可以补充实质内容，实在不行和导师说先交初稿" } },
  { dim:"WS", aVal:"W", dimLabel:"📝 论文风格", title:"📝 你的「研究局限性」一节通常怎么写？",
    a:{ label:"模板派", desc:"「本研究样本量较小，未来研究可进一步扩展……」复制上篇改改，万能模板" },
    b:{ label:"认真派", desc:"认真反思了真实的局限，写了具体的方法论问题，哪怕导师看了皱眉" } },
  { dim:"WS", aVal:"W", dimLabel:"📝 论文风格", title:"📝 审稿人说你论文「内容过于单薄」，你第一反应是？",
    a:{ label:"包装派", desc:"加几个图表，把讨论扩展两页，多引几篇文献装点门面，让它「看起来」丰富" },
    b:{ label:"实质派", desc:"重新思考论点，看是否需要补实验或补数据，从根本上解决问题" } },
  { dim:"CE", aVal:"C", dimLabel:"📚 文献态度", title:"📚 写文献综述时，你的真实操作是？",
    a:{ label:"搬运派", desc:"找5篇高引文章，把他们的引言重新排列组合，换个说法，行云流水" },
    b:{ label:"挖掘派", desc:"读完再写，不然写出来自己都知道是胡说，而且会被审稿人抓到" } },
  { dim:"CE", aVal:"C", dimLabel:"📚 文献态度", title:"📚 看到一篇关键文献是1998年的英文paper，你会？",
    a:{ label:"摘要派", desc:"看看摘要，记个结论，顺手引用，doi复制完事，效率第一" },
    b:{ label:"深挖派", desc:"打开全文，看方法论，有时候还会追它引用的那篇1987年的鼻祖文章" } },
  { dim:"CE", aVal:"C", dimLabel:"📚 文献态度", title:"📚 你的Zotero/文献库现状是？",
    a:{ label:"囤积派", desc:"几百篇，大多数只看过标题，但引用起来非常顺手，能找到就行" },
    b:{ label:"精读派", desc:"分了文件夹，有笔记，读过的有标注，虽然数量不如别人多但质量还行" } },
  { dim:"FR", aVal:"F", dimLabel:"🧑‍🏫 导师关系", title:"🧑‍🏫 导师在组会上否定了你两个月的研究方向，要换题，你？",
    a:{ label:"顺从型", desc:"「好的老师。」当天晚上开始查新方向，没有任何情绪波动，执行力满分" },
    b:{ label:"抵抗型", desc:"「好的老师。」内心：什么叫换题，当初是谁同意这个方向的？" } },
  { dim:"FR", aVal:"F", dimLabel:"🧑‍🏫 导师关系", title:"🧑‍🏫 导师让你在论文里加一个你觉得完全多余的章节，你？",
    a:{ label:"服从型", desc:"加！导师说有用就有用，也许是我理解不到位，先做再说，别想那么多" },
    b:{ label:"应付型", desc:"加。但在那个章节里悄悄写得很敷衍，内心保留自己的学术坚持" } },
  { dim:"FR", aVal:"F", dimLabel:"🧑‍🏫 导师关系", title:"🧑‍🏫 导师把你精心设计的研究方法改得面目全非，你？",
    a:{ label:"接受型", desc:"认真学习，也许导师的方法更成熟，我还不够有经验，应该信任导师" },
    b:{ label:"存档型", desc:"改了。但把原来的方案偷偷存在草稿里，「万一有用呢」，留着备用" } },
  { dim:"JT", aVal:"J", dimLabel:"⏰ 科研心态", title:"⏰ 实验室同学发了一篇顶刊，你的第一反应是？",
    a:{ label:"内卷型", desc:"打开自己的文档，今晚不睡了，我也要投出去，落后了落后了" },
    b:{ label:"躺平型", desc:"哦。去给他点了个赞，继续刷手机，反正又不是竞争" } },
  { dim:"JT", aVal:"J", dimLabel:"⏰ 科研心态", title:"⏰ 还有3天截止，论文还差5000字，你在干什么？",
    a:{ label:"卷王型", desc:"已经在写了，昨天就开始了，今天是第三稿，不写完不睡觉" },
    b:{ label:"佛系型", desc:"刚打开文档。5000字，3天，很轻松的……吧？（开始看视频）" } },
  { dim:"JT", aVal:"J", dimLabel:"⏰ 科研心态", title:"⏰ 你理想中的科研生活是？",
    a:{ label:"进取型", desc:"每天产出，持续迭代，争取多发几篇，简历要好看，offer要抢手，卷赢所有人" },
    b:{ label:"自洽型", desc:"做自己感兴趣的，发不发顶刊无所谓，不焦虑、不内耗就是成功" } },
];
